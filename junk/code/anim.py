...
def g():
    ...
    sprite.scale = rabbyt.ease(0.50,   1.5, dt=1, extend="reverse")
    sprite.rot   = rabbyt.ease(0.00, 360.0, dt=1, extend="extrapolate")
    ...
    #)
    sprite.red   = rabbyt.lerp(0.25, 1.00, dt=2, extend="reverse")
    sprite.green = rabbyt.lerp(0.25, 1.00, dt=3, extend="reverse")
    sprite.blue  = rabbyt.lerp(0.25, 1.00, dt=4, extend="reverse")
